# Generated by Django 3.0.7 on 2020-10-29 23:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_projects', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='app.Project')),
                ('prof_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'profiles',
            },
